...
Sources: [`DRISTY_ARCHITECTURE.md`](DRISTY_ARCHITECTURE.md) §4–§10, [`dristy_modes.c`](../firmware/hackylens/firmware/src/dristy/dristy_modes.c), [`dristy_mode_readiness.c`](../firmware/hackylens/firmware/src/dristy/dristy_mode_readiness.c).
