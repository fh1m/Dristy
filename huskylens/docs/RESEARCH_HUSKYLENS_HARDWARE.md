# HuskyLens SEN0305 Hardware & Stock Firmware — Deep Report
...
Custom firmware on SEN0305 implementing QR decode (as HackyLens does via quirc)
...
with chip ID 0x9d. Runtime probe of both addresses is cheap. HackyLens
...
No `huskylens_ros`, no driver node, nothing published. A Dristy ROS2 driver
