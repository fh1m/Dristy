#!/usr/bin/env python3
"""Reject product-facing legacy HackyLens/HuskyLens branding outside allowlists."""
...
PATTERN = re.compile(r"HackyLens|HuskyLens|HUSKYLENS|hackylens|huskylens", re.I)
