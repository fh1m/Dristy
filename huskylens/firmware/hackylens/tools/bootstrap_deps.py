...
export HACKYLENS_MICROPYTHON_DIR="{MICROPYTHON_DIR.resolve()}"
export HACKYLENS_LITTLEFS_DIR="{LITTLEFS_DIR.resolve()}"
export CC="{host_gcc.resolve()}"
echo "[HackyLens] KENDRYTE_SDK_DIR=$KENDRYTE_SDK_DIR"
echo "[HackyLens] KENDRYTE_TOOLCHAIN_BIN=$KENDRYTE_TOOLCHAIN_BIN"
echo "[HackyLens] HACKYLENS_MICROPYTHON_DIR=$HACKYLENS_MICROPYTHON_DIR"
echo "[HackyLens] HACKYLENS_LITTLEFS_DIR=$HACKYLENS_LITTLEFS_DIR"
echo "[HackyLens] CC=$CC"
"""
    env_path.write_text(content, encoding="utf-8")
    print(f"[OK] env: {env_path}")
