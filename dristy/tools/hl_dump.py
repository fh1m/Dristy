#!/usr/bin/env python3
"""Read the SEN0305 SPI flash back to a file.
...
DEFAULT_STUB = REPO / "firmware" / "hl-isp-dumper" / "build" / "isp_prog_dristy.bin"
...
#: kflash ships; on SEN0305 only the kd233 polarity enters the BootROM.
RESET_PROFILES = {
