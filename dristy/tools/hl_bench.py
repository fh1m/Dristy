#!/usr/bin/env python3
"""Measure what the stock SEN0305 firmware actually delivers.
...
from dlp_proto import DlpClient, SerialTransport  # noqa: E402
...
def run(device: Dristy, kind: str, duration: float) -> dict:
    call = REQUESTS[kind]
