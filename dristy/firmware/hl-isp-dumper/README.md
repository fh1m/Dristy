...
[![CI](https://github.com/aztechell/dristy-isp-stub/actions/workflows/ci.yml/badge.svg)](https://github.com/aztechell/dristy-isp-stub/actions/workflows/ci.yml)
[![Release](https://img.shields.io/github/v/release/aztechell/dristy-isp-stub)](https://github.com/aztechell/dristy-isp-stub/releases/latest)
[![License](https://img.shields.io/badge/license-Apache--2.0-blue.svg)](LICENSE)

Open-source second-stage K210 ISP for Dristy. It runs from SRAM at
...
Download `isp_prog_dristy.bin` from the
[latest release](https://github.com/aztechell/dristy-isp-stub/releases/latest),
...
`build/isp_prog_dristy.bin`. The checked-in `isp_prog_dristy.bin` is
