...
class DisplayContractTests(unittest.TestCase):
    ...
    def test_public_abi_and_fake_are_fixed_capacity(self) -> None:
        ...
        """
        with tempfile.TemporaryDirectory(prefix="dristy-display-abi-") as temp:
            temporary = Path(temp)
    ...
    def test_phase_2_8_enters_production_through_the_capability(self) -> None:
        ...
        self.assertIn('id = "dristy.cap.display"', catalog)
        self.assertIn(
        ...
        self.assertIn("dristy/capability/display.h", production)
