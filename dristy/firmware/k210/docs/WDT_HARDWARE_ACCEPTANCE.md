...
```powershell
python tools\build_firmware.py full --board sen0305 --wdt-fault-injection
python tools\hkflash.py flash-monitor build\sen0305\dristy-full-wdtfi.bin --board sen0305 --port COM10 --duration 10 --allow-missing-sidecar
```
