---
contract-id: dristy.versioning-policy
owner: platform-architecture
version: 0.4.0
stability: experimental
---

# Dristy Contract Versioning Policy

This policy defines independent semantic-version lines and the lifecycle of
Dristy public contracts.
...
`dristy.legacy-app-lifecycle` version `0.2.0` describes the lifecycle shipped
