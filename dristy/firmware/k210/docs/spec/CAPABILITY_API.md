---
contract-id: dristy.capability-api
owner: platform-architecture
version: 0.1.0
stability: experimental
---

# Dristy Capability API

## Purpose and scope

This contract defines the common native ABI and lifecycle for portable
Dristy hardware capabilities. Native firmware and language adapters MUST use
...
|---:|---|---|
| `0x00010001` | `dristy.cap.time` | `dristy.capability.time` |
| `0x00010002` | `dristy.cap.input` | `dristy.capability.input` |
| `0x00010003` | `dristy.cap.display` | `dristy.capability.display` |
| `0x00010004` | `dristy.cap.external-link` | `dristy.capability.external-link` |
| `0x00010005` | `dristy.cap.lights` | `dristy.capability.lights` |
