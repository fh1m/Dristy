---
contract-id: dristy.capability.external-link
...
- Canonical name: `dristy.cap.external-link`.
...
The public ABI is
`firmware/include/dristy/capability/external_link.h`. All extensible input
