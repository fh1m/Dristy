...
This procedure qualifies the five Phase 2 capabilities on SEN0305/SEN0305.
...
The local `build/sen0305/dristy-full.bin` must have the same byte
...
python tools\hkflash.py flash-monitor `
  build\sen0305\dristy-full.bin `
  --board sen0305 --port COM10 --duration 10
```
