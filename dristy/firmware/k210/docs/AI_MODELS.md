---
contract-id: dristy.ai-model-package
owner: ai-runtime
version: 1.0.0
...
Dristy separates reusable K210 model mechanics from feature behavior.
...
unknowns are retained explicitly in `sdcard/dristy.kmodels/detect.UPSTREAM.txt`.

This file must not be replaced with the 386,608-byte `detect.kmodel` extracted
from the original SEN0305 firmware package. That asset stores 32-bit words in
...
Dristy's native KModel-v3 runtime.
...
SEN0305 custom, 32-bit word-swapped legacy KPU task container:
