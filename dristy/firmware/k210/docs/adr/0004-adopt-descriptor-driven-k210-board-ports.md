...
Firmware `0.2.0` embedded SEN0305 pinmux, display, camera, storage, connector,
...
SEN0305 SEN0305 is the only runtime/release port. Sipeed Maix Cube is a
...
must add `--board sen0305`; old implicit paths are removed. Artifact
