...
- [x] Добавить normative `docs/spec/CAPABILITY_API.md` с metadata:
  `contract-id: dristy.capability-api`, owner `platform-architecture`, version
...
- `firmware/include/dristy/capability/common.h`
- `firmware/include/dristy/capability/inventory.h`
- `firmware/include/dristy/capability/owner.h`
...
passed in [`Release firmware` run 32343616128](https://github.com/aztechell/dristy/actions/runs/32343616128).
...
- [x] Добавить `dristy.cap.time` version `0.1.0` и K210 adapter.
...
- `firmware/include/dristy/capability/time.h`
...
profiles passed in [`Release firmware` run 32345756423](https://github.com/aztechell/dristy/actions/runs/32345756423).
...
- [x] Добавить `dristy.cap.input` version `0.1.0`.
...
- `firmware/include/dristy/capability/input.h`
...
firmware profiles passed in [`Release firmware` run 32377337624](https://github.com/aztechell/dristy/actions/runs/32377337624).
...
- [x] Добавить `dristy.cap.lights` version `0.1.0`.
...
- `firmware/include/dristy/capability/lights.h`
...
repair regions, and both firmware profiles passed in [`Release firmware` run 32393480686](https://github.com/aztechell/dristy/actions/runs/32393480686).
...
- [x] Добавить `dristy.cap.display` version `0.1.0`.
...
- `firmware/include/dristy/capability/display.h`
...
passed in [`Release firmware` run 32405344851](https://github.com/aztechell/dristy/actions/runs/32405344851).
...
passed in
[`Release firmware` run 32414243642](https://github.com/aztechell/dristy/actions/runs/32414243642).
...
- [x] Добавить `dristy.cap.external-link` version `0.1.0`.
...
- `firmware/include/dristy/capability/external_link.h`
...
[`Release firmware` run 32557338515](https://github.com/aztechell/dristy/actions/runs/32557338515).
...
[`Release firmware` run 32565126272](https://github.com/aztechell/dristy/actions/runs/32565126272):
...
[`Release firmware` run 32569674140](https://github.com/aztechell/dristy/actions/runs/32569674140):
