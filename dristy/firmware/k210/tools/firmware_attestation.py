...
SCHEMA_VERSION = 2
ATTESTATION_TYPE = "dristy-firmware-build"
FULL_BUILD_PROFILE = "dristy-full"
FEATURE_BUILD_PROFILE = "dristy-feature-modified"
FAULT_BUILD_PROFILE = "dristy-wdt-fault-injection"
