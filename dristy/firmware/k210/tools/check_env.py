#!/usr/bin/env python3
"""Check the local Dristy development environment."""
...
def main() -> int:
    ...
    print(f"Dristy {version} full environment check")
    print("=======================================")
    ok = True
