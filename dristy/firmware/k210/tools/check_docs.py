#!/usr/bin/env python3
"""Validate Dristy documentation governance contracts."""
...
def check_canonical_versions(
    ...
    mappings = (
        (
            ...
            r"^# Dristy MicroPython Protocol \(HMPY\) v(\d+)\s*$",
        ),
        (
            ...
            r"^# Dristy External Link Protocol v(\d+)\s*$",
        ),
        (
        ...
        (
            ...
            r"^# Dristy MicroPython API v(\d+)\s*$",
        ),
    )
