#!/usr/bin/env python3
"""Create versioned Dristy firmware and SD-card artifacts."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Package a Dristy release")
    ...
    if args.firmware is None:
        args.firmware = ROOT / "dist" / f"dristy-full-{board.id}.bin"
    ...
    artifact_stem = f"dristy-{board.id}-v{version}"
