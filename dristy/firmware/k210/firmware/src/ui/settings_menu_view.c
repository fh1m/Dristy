                                 ...
                                 uint8_t editing)
{
    ...
    value_x = HK_DISPLAY_REQUIRED_WIDTH - 12U - (uint16_t)(value_length * DRISTY_FONT_W);

    hk_ui_display_fill_rect(8, y, HK_DISPLAY_REQUIRED_WIDTH - 16, SETTINGS_MENU_ROW_H - 4, bg);
    hk_ui_display_draw_text_at(12, (uint16_t)(y + (SETTINGS_MENU_ROW_H - DRISTY_FONT_H) / 2U),
                               title, fg, bg);
    if(editing)
        hk_ui_display_draw_text_at(value_x - DRISTY_FONT_W,
                                   (uint16_t)(y + (SETTINGS_MENU_ROW_H - DRISTY_FONT_H) / 2U),
                                   "*", fg, bg);
