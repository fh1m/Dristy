                                    ...
                                    uint16_t y)
{
    ...
    uint16_t source_x0 = (uint16_t)(x * DRISTY_FONT_W / PY_FONT_W);
    uint16_t source_x1 = (uint16_t)((x + 1U) * DRISTY_FONT_W /
                                    PY_FONT_W);
    uint16_t source_y0 = (uint16_t)(y * DRISTY_FONT_H / PY_FONT_H);
    uint16_t source_y1 = (uint16_t)((y + 1U) * DRISTY_FONT_H /
                                    PY_FONT_H);
    uint16_t covered = 0U;
    uint16_t samples = 0U;
    ...
    for(uint16_t source_y = source_y0; source_y < source_y1; source_y++)
    {
        ...
        {
            uint8_t bit = glyph[
                source_y * DRISTY_FONT_ROW_BYTES + source_x / 8U] &
