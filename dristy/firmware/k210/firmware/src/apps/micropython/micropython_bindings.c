...
static const mp_rom_map_elem_t dristy_module_globals_table[] = {
    { MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_dristy) },
...
static MP_DEFINE_CONST_DICT(dristy_module_globals,
                            dristy_module_globals_table);

const mp_obj_module_t dristy_user_module = {
    .base = {&mp_type_module},
    .globals = (mp_obj_dict_t *)&dristy_module_globals,
};

MP_REGISTER_MODULE(MP_QSTR_dristy, dristy_user_module);
