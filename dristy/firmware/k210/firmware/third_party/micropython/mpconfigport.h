#ifndef DRISTY_MICROPYTHON_MPCONFIGPORT_H
#define DRISTY_MICROPYTHON_MPCONFIGPORT_H
...
#define MICROPY_PY_SYS_PLATFORM "dristy-k210"
...
/* Implemented by the Dristy core-1 runtime port.  The VM and iterator
