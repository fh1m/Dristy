...
static void dristy_early_init(void)
{
}

static void dristy_lights_prepare(void)
{
...
static void dristy_display_prepare(void)
{
...
static void dristy_buttons_prepare(void)
{
...
static void dristy_sd_prepare(void)
{
...
static void dristy_camera_prepare(void)
{
...
static void dristy_internal_flash_prepare(void)
{
    /* K210 SPI3 is dedicated to the on-board flash; no FPIOA route is needed. */
}

static void dristy_external_uart_prepare(void)
{
...
static void dristy_external_i2c_prepare(void)
{
...
const hk_board_ops_t hk_board_ops = {
    .early_init = dristy_early_init,
    .display_prepare = dristy_display_prepare,
    .camera_prepare = dristy_camera_prepare,
    .buttons_prepare = dristy_buttons_prepare,
    .lights_prepare = dristy_lights_prepare,
    .internal_flash_prepare = dristy_internal_flash_prepare,
    .sd_prepare = dristy_sd_prepare,
    .external_uart_prepare = dristy_external_uart_prepare,
    .external_i2c_prepare = dristy_external_i2c_prepare,
};
